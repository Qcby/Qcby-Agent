...
ensure_existing_defaults() {
  ...
  ADMIN_USERNAME="${ADMIN_USERNAME:-${BOOTSTRAP_ADMIN_USERNAME:-admin}}"
  ADMIN_PASSWORD="${ADMIN_PASSWORD:-${BOOTSTRAP_ADMIN_PASSWORD:-change-me-admin-password}}"
  ONLINE_SECONDS="${ONLINE_SECONDS:-90}"
